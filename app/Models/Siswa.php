...
class Siswa extends Model
{
    ...
    /**
     * Get the sd that owns the Siswa
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function sd(): BelongsTo
    {
        return $this->belongsTo(SekolahSd::class, 'nis', 'nis')->withDefault();
    }
    ...
    /**
     * Get the siswaKip that owns the Siswa
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function siswaKip(): BelongsTo
    {
        return $this->belongsTo(SiswaKip::class, 'nis', 'nis')->withDefault();
    }
